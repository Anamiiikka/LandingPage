...
export default function Chatbot() {
    ...
    simulateTyping(() => {
      switch (option) {
        ...
        case "View All Services":
          addMessage("We specialize in cutting-edge technology solutions: Web Development (React, Next.js), Mobile Apps (React Native, Flutter), UI/UX Design, Digital Marketing, Cloud Solutions, and Strategic Consulting. Each service is delivered with premium quality and attention to detail.", true, ["Book Consultation", "Get Quote", "Contact Us", "Back to Menu"]);
          break;
        
        case "View Available Times":
          addMessage("Our consultation slots are available Monday-Friday, 9 AM - 6 PM EST. We also offer weekend appointments for urgent projects. Would you like to book a specific time?", true, ["Book Now", "Call to Schedule", "Back to Menu"]);
          break;
        
        case "View Pricing Plans":
          addMessage("Our pricing is project-based and tailored to your needs:\n\n• Web Development: Starting from $5,000\n• Mobile Apps: Starting from $15,000\n• UI/UX Design: Starting from $3,000\n• Digital Marketing: Starting from $2,000/month\n\nFor accurate pricing, I recommend getting a custom quote!", true, ["Get Custom Quote", "Book Consultation", "Back to Menu"]);
          break;
        
        case "Call Us":
          addMessage("You can reach us directly at: +1 (555) 123-4567\n\nOur team is available Monday-Friday, 9 AM - 6 PM EST. For immediate assistance, you can also schedule a callback!", true, ["Schedule Callback", "Send Email", "Back to Menu"]);
          break;
        
        case "Email Us":
          addMessage("Send us an email at: hello@yourcompany.com\n\nWe typically respond within 2-4 hours during business days. For faster response, you can also fill out our contact form!", true, ["Contact Form", "Schedule Call", "Back to Menu"]);
          break;
        
        case "Speak to Agent":
        case "Contact Support":
          addMessage("I'll connect you with one of our specialists right away! They'll be able to provide detailed information and personalized assistance for your project.", true, ["Schedule Call", "Send Message", "Back to Menu"]);
          break;
        
        case "Back to Menu":
          addMessage("How else can I assist you today?", true, ["Book Appointment", "Get Quote", "Learn More", "Contact Us"]);
          break;
        
        default:
          addMessage("Thank you for your interest! How would you like to proceed?", true, ["Book Appointment", "Get Quote", "Contact Us", "Back to Menu"]);
      }
    });
  };
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    simulateTyping(() => {
      addMessage(`🎉 Perfect! Your premium consultation has been scheduled for ${bookingForm.date} at ${bookingForm.time}. 
...
You'll receive a confirmation email with meeting details and preparation materials shortly. We're excited to work with you!`, true, ["Reschedule", "Add to Calendar", "Contact Support"]);
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    simulateTyping(() => {
      addMessage(`Thank you ${contactForm.name}! Your message has been received and forwarded to our team. 

We'll get back to you within 2-4 hours at ${contactForm.email}. 

For urgent matters, feel free to call us at +1 (555) 123-4567.`, true, ["Book Appointment", "Get Quote", "Call Us"]);
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    ...
    simulateTyping(() => {
      addMessage(`Excellent! Your custom quote request has been submitted successfully.
...
The proposal will include project scope, timeline, pricing, and next steps.`, true, ["Book Consultation", "Modify Request", "Contact Team"]);
              ...
              <div className="p-6 overflow-y-auto">
                ...
                <form onSubmit={handleBookingSubmit} className="space-y-5">
                  ...
                  >
                    ...
                    <option value="Strategic Consulting" className="bg-black">Strategic Consulting</option>
            ...
            {currentView === "quote" && (
              <div className="p-6 overflow-y-auto">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg gradient-text">Get Custom Quote</h3>
                    <p className="text-sm text-white/60">Receive detailed proposal within 24 hours</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleQuoteSubmit} className="space-y-5">
                  ...
                  <select
                    ...
                    style={{ pointerEvents: 'auto' }}
                  >
                    <option value="" className="bg-black">Select Primary Service</option>
                    <option value="Web Development" className="bg-black">Web Development</option>
                    <option value="Mobile Development" className="bg-black">Mobile Development</option>
                    <option value="UI/UX Design" className="bg-black">UI/UX Design</option>
                    <option value="Digital Marketing" className="bg-black">Digital Marketing</option>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <option value="$50,000 - $100,000" className="bg-black">$50,000 - $100,000</option>
                      <option value="Over $100,000" className="bg-black">Over $100,000</option>
                    </select>
                    ...
                    <select
                      ...
                      style={{ pointerEvents: 'auto' }}
                    >
                      <option value="" className="bg-black">Timeline</option>
                      <option value="ASAP (Rush)" className="bg-black">ASAP (Rush)</option>
                  ...
                  <Textarea
                    placeholder="Describe your project in detail. Include features, requirements, target audience, and any specific needs..."
                    value={quoteForm.description}
                    onChange={(e) => setQuoteForm(prev => ({ ...prev, description: e.target.value }))}
                    className="bg-white/5 border-white/20 rounded-xl focus:border-white/40 min-h-[100px] resize-none z-10"
                    required
                    style={{ pointerEvents: 'auto' }}
                  />
